...
# каждый продукт из products, если его ещё нет в файле (по названию). Если такой продукт уже есть, то не добавляет и выводит строку 'Продукт <название> уже есть в магазине' .
    ...
    def add(self, *products):
        with open(self.__file_name, 'a') as file:
            for product in products:
                if self.get_products().find(str(product)) == -1:
